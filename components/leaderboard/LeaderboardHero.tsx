...
const LeaderboardHero: FC<LeaderBoardHeroProps> = ({ discipline }) => {
  ...
  return (
    <div className="relative aspect-[3/1] w-full sm:aspect-[4/1] lg:aspect-[5/1]">
      ...
      />
      <h1 className="absolute left-1/2 top-1/2 w-full -translate-x-1/2 -translate-y-1/2 text-center text-4xl font-extrabold text-primary-foreground drop-shadow-lg sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl">
